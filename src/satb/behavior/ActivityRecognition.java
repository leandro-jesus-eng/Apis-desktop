...
public class ActivityRecognition implements Runnable {
        ...
        if (listMDS.size() > 0) {
            ...
            for (SegmentDataStructure sds : listSDS) {
                ...
                if (qtdAlteracoesMovimento != 0) {
                    ...
                    if (countForwardToNonMoving == null) {
                        countForwardToNonMoving = 0;
                    }
                    ...
                    if (countForwardToUturn == null) {
                        countForwardToUturn = 0;
                    }
                    ...
                    if (countForwardToLeft == null) {
                        countForwardToLeft = 0;
                    }
                    ...
                    if (countForwardToRight == null) {
                        countForwardToRight = 0;
                    }
                    ...
                    if (countNonMovingToForward == null) {
                        countNonMovingToForward = 0;
                    }
                    ...
                    if (countNonMovingToUturn == null) {
                        countNonMovingToUturn = 0;
                    }
                    ...
                    if (countNonMovingToLeft == null) {
                        countNonMovingToLeft = 0;
                    }
                    ...
                    if (countNonMovingToRight == null) {
                        countNonMovingToRight = 0;
                    }
                    ...
                    if (countUturnToForward == null) {
                        countUturnToForward = 0;
                    }
                    ...
                    if (countUturnToNonmoving == null) {
                        countUturnToNonmoving = 0;
                    }
                    ...
                    if (countLeftToForward == null) {
                        countLeftToForward = 0;
                    }
                    ...
                    if (countLeftToNonmoving == null) {
                        countLeftToNonmoving = 0;
                    }
                    ...
                    if (countRightToForward == null) {
                        countRightToForward = 0;
                    }
                    ...
                    if (countRightToNonmoving == null) {
                        countRightToNonmoving = 0;
                    }
    ...
    public Instances createARFFDataFromMDS(LinkedList<MovementDataStructure> listMDSClassification, boolean meterologicalData) {
        FastVector atts;
        Instances data;
        double[] vals;
        ...
        if (meterologicalData == true) {
            atts.addElement(new Attribute(MeteorologicalData.TEMPERATURA_DO_AR));
            atts.addElement(new Attribute(MeteorologicalData.TEMPERATURA_MAXIMA));
            atts.addElement(new Attribute(MeteorologicalData.TEMPERATURA_MINIMA));
            atts.addElement(new Attribute(MeteorologicalData.UMIDADE_RELATIVA_DO_AR));
            atts.addElement(new Attribute(MeteorologicalData.UMIDADE_RELATIVA_DO_AR_MAXIMA));
            atts.addElement(new Attribute(MeteorologicalData.UMIDADE_RELATIVA_DO_AR_MINIMA));
            atts.addElement(new Attribute(MeteorologicalData.TEMPERATURA_DO_PONTO_DE_ORVALHO));
            atts.addElement(new Attribute(MeteorologicalData.TEMPERATURA_DO_PONTO_DE_ORVALHO_MAXIMA));
            atts.addElement(new Attribute(MeteorologicalData.TEMPERATURA_DO_PONTO_DE_ORVALHO_MINIMA));
            atts.addElement(new Attribute(MeteorologicalData.PRESSAO_ATMOSFERICA));
            atts.addElement(new Attribute(MeteorologicalData.PRESSAO_ATMOSFERICA_MAXIMA));
            atts.addElement(new Attribute(MeteorologicalData.PRESSAO_ATMOSFERICA_MINIMA));
            atts.addElement(new Attribute(MeteorologicalData.VENTO_VELOCIDADE));
            atts.addElement(new Attribute(MeteorologicalData.VENTO_DIRECAO));
            atts.addElement(new Attribute(MeteorologicalData.VENTO_RAJADA_MAXIMA));
            atts.addElement(new Attribute(MeteorologicalData.RADIACAO_GLOBAL));
            atts.addElement(new Attribute(MeteorologicalData.PRECIPITACAO));
        }
        ...
        atts.addElement(new Attribute("hora"));
        atts.addElement(new Attribute("class", classificacao));
        ...
        for (MovementDataStructure mds : listMDSClassification) {
            ...
            vals[i++] = mds.getDeltaAz();
            vals[i++] = mds.getDeltaGx();
            vals[i++] = mds.getDeltaGy();
            vals[i++] = mds.getDeltaGz();
            vals[i++] = mds.getDeltaMx();
            vals[i++] = mds.getDeltaMy();
            ...
            if (meterologicalData == true) {
                ...
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.UMIDADE_RELATIVA_DO_AR);
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.UMIDADE_RELATIVA_DO_AR_MAXIMA);
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.UMIDADE_RELATIVA_DO_AR_MINIMA);
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.TEMPERATURA_DO_PONTO_DE_ORVALHO);
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.TEMPERATURA_DO_PONTO_DE_ORVALHO_MAXIMA);
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.TEMPERATURA_DO_PONTO_DE_ORVALHO_MINIMA);
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.PRESSAO_ATMOSFERICA);
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.PRESSAO_ATMOSFERICA_MAXIMA);
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.PRESSAO_ATMOSFERICA_MINIMA);
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.VENTO_VELOCIDADE);
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.VENTO_DIRECAO);
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.VENTO_RAJADA_MAXIMA);
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.RADIACAO_GLOBAL);
                vals[i++] = MeteorologicalData.getValue(mds.getListMeteorologicalData(), MeteorologicalData.PRECIPITACAO);
            } 
